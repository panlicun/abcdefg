...
import com.plc.abcdefg.kernel.datasource.properties.DruidProperties;
...
public class MybatisPluginAutoConfiguration {
    ...
    public PaginationInterceptor paginationInterceptor() {
        ...
        if (druidProperties.getUrl().contains("oracle")) {
            paginationInterceptor.setDialectType(DbType.ORACLE.getValue());
        } else if (druidProperties.getUrl().contains("postgresql")) {
            paginationInterceptor.setDialectType(DbType.POSTGRE_SQL.getValue());
        } else if (druidProperties.getUrl().contains("sqlserver")) {
            paginationInterceptor.setDialectType(DbType.SQL_SERVER.getValue());
        } else {
