...
import com.plc.producer3.common.core.datascope.DataScopeInterceptor;
import com.plc.producer3.common.enums.DatasourceEnum;
...
@MapperScan(basePackages = {"com.plc.producer3.modular.*.mapper"})
